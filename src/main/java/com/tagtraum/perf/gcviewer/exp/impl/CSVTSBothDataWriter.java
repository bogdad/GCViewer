 ...
 * <p>
 * It uses the {@literal "Timestamp(sec/#),Timestamp(unix/#),Used(K),Total(K),Pause(sec),GC-Type"} format.
 *
 * @author <a href="mailto:hs@tagtraum.com">Hendrik Schreiber</a>
 */
public class CSVTSBothDataWriter extends AbstractDataWriter {

  public CSVTSBothDataWriter(OutputStream out) {
    super(out);
  }

  private void writeHeader() {
    out.println("Timestamp(sec/#),Timestamp(unix/#),Used(K),Total(K),Pause(sec),GC-Type");
  }
